...
The model name is the main value most users should change. The apps default to `global.anthropic.claude-sonnet-4-5-20250929-v1:0` and `ap-southeast-2` when the variables are omitted.
