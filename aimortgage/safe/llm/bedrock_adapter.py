...
_OUTPUT_LOG = Path(__file__).parent.parent / "output.txt"
...
class BedrockAdapter:
    ...
    @staticmethod
    def _log_output(parsed: dict) -> None:
        try:
            with open(_OUTPUT_LOG, "a") as f:
                ...
                if tool_calls:
                    f.write(f"[{ts}] tool_calls={json.dumps(tool_calls)}\n")
        except Exception:
            pass
